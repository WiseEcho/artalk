...
func CorsMiddleware(app *core.App) func(*fiber.Ctx) error {
	return cors.New(cors.Config{
		AllowHeaders: "Origin,Content-Length,Content-Type,Access-Control-Allow-Origin,X-Request-Id,authorization,Authorization,Accept,User-Agent,X-Remain-Request,X-Platform,x-platform",
